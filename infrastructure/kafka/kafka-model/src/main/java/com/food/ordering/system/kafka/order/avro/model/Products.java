...
public class Products extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6348452887346786405L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Products\",\"namespace\":\"com.food.ordering.system.kafka.order.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"logicalType\":\"uuid\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public Products(java.lang.String id, java.lang.Integer quantity) {
    this.id = id;
   ...
   */
  public static com.food.ordering.system.kafka.order.avro.model.Products.Builder newBuilder() {
    return new com.food.ordering.system.kafka.order.avro.model.Products.Builder();
  }
   ...
   * @return A new Products RecordBuilder
   */
  public static com.food.ordering.system.kafka.order.avro.model.Products.Builder newBuilder(com.food.ordering.system.kafka.order.avro.model.Products.Builder other) {
    if (other == null) {
      return new com.food.ordering.system.kafka.order.avro.model.Products.Builder();
    } else {
      return new com.food.ordering.system.kafka.order.avro.model.Products.Builder(other);
    }
  }
   ...
   * @return A new Products RecordBuilder
   */
  public static com.food.ordering.system.kafka.order.avro.model.Products.Builder newBuilder(com.food.ordering.system.kafka.order.avro.model.Products other) {
    if (other == null) {
      return new com.food.ordering.system.kafka.order.avro.model.Products.Builder();
    } else {
      return new com.food.ordering.system.kafka.order.avro.model.Products.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Products>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.food.ordering.system.kafka.order.avro.model.Products.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.food.ordering.system.kafka.order.avro.model.Products other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.Products.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.Products.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.Products.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.Products.Builder clearQuantity() {
